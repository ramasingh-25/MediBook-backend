...
using MediBook.AppointmentService.Repositories;
using MediBook.AppointmentService.Services;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Appointment management service for MediBook application"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "MediBook Appointment Service API v1");
