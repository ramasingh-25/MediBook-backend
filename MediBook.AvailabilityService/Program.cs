...
using MediBook.AvailabilityService.Repositories;
using MediBook.AvailabilityService.Services;
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    {
        Title = "MediBook Availability Service API",
        Version = "v1",
        Description = "Availability and scheduling service for MediBook application"
    });
...
{
    options.SwaggerEndpoint("/swagger/v1/swagger.json", "MediBook Availability Service API v1");
});
