...
using MediBook.ProviderService.Repositories;
using MediBook.ProviderService.Services;
...
builder.Services.AddSwaggerGen(options =>
{
    options.SwaggerDoc("v1", new Microsoft.OpenApi.Models.OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Provider management service for MediBook application"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        options.SwaggerEndpoint("/swagger/v1/swagger.json", "MediBook Provider Service API v1");
